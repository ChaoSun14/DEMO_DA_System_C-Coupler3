...
void import_report_setting()
{
    ...
    int line_number;
    char keywords[6][NAME_STR_SIZE];
    bool report_setting[6];
	...
	sprintf(keywords[5], "output_H2D_grid");
	...
	output_H2D_grid_enabled = report_setting[5];
}
