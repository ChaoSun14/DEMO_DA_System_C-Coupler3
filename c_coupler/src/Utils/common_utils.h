...
#define ABS_TOLERANCE_LOW ((double) 1e-8)
#define ABS_TOLERANCE     ((double) 1e-10)
#define ABS_TOLERANCE_HI  ((double) 1e-11)
#define RELATIVE_TOLERANCE_LOW ((double) 1e-3)
#define RELATIVE_TOLERANCE     ((double) 1e-4)
#define RELATIVE_TOLERANCE_HI  ((double) 1e-5)

#define float_eq_low(a, b) (fabs(a - b) <= ABS_TOLERANCE_LOW)
#define float_eq(a, b)     (fabs(a - b) <= ABS_TOLERANCE)
#define float_eq_hi(a, b)  (fabs(a - b) <= ABS_TOLERANCE_HI)

#define relative_eq_int(a, b, t) (fabs(a - b)/(fabs(a) + fabs(b)) <= t)

#define relative_eq_low(a, b)   relative_eq_int(a, b, RELATIVE_TOLERANCE_LOW)
#define relative_eq(a, b)       relative_eq_int(a, b, RELATIVE_TOLERANCE)
#define relative_eq_hi(a, b)    relative_eq_int(a, b, RELATIVE_TOLERANCE_HI)
...
extern long calculate_checksum_of_array(const void *, int, int, const int *, MPI_Comm);
