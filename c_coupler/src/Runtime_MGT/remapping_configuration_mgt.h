...
class H2D_remapping_wgt_file_info
{
    ...
    public:
        ...
        bool get_wgt_file_grid_checksum(int, const char *, const char*, int, long &);
        void read_grid_size(int, const char *, int &);
        void read_weight_grid_data(int, const char *, const char *, void **, int, bool);
        double *get_src_area() { return NULL; }
        double *get_dst_area() { return NULL; }
		void read_in_all_checksums(Comp_comm_group_mgt_node *);
};
...
class H2D_remapping_wgt_file_container
{
    ...
    public:
        H2D_remapping_wgt_file_container() { H2D_remapping_wgt_files.clear(); }
...
class Remapping_algorithm_specification
{
    ...
    public:
        ...
        Remapping_algorithm_specification() { comp_id = -1; type_id = -1; algorithm_name = NULL; }
