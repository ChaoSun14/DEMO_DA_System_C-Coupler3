...
#define INTERFACE_SOURCE_IO_INPUT             ((int)2)
...
class Inout_interface
{
    ...
    public:
		...
		int get_num_fields_mem_registered() { return fields_mem_registered.size(); }
		Field_mem_info *get_field_mem(int);
		bool get_field_connected_status(int i) { return fields_connected_status[i]; }
		Runtime_trans_algorithm *get_unique_data_send_algorithm();
		void set_rearranging_intra_a_component();
};
