...
class Runtime_remapping_weights
{
    ...
    public:
        Runtime_remapping_weights(const char*, const char*, Original_grid_info *, Original_grid_info *, Remapping_setting *, Decomp_info*, H2D_remapping_wgt_file_info *);
...
class Runtime_remapping_weights_container
{
	...
	public:
		Runtime_remapping_weights_container(const char*, const char*, Original_grid_info *, Original_grid_info *, Remapping_setting *, Decomp_info*, H2D_remapping_wgt_file_info *);
...
class Runtime_remapping_weights_mgt
{
    ...
    public:
        ...
        ~Runtime_remapping_weights_mgt();
        Runtime_remapping_weights *search_or_generate_runtime_remapping_weights(const char *, const char*, Original_grid_info *, Original_grid_info *, Remapping_setting *, Decomp_info*, H2D_remapping_wgt_file_info *);
