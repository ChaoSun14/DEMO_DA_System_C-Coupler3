...
class Runtime_trans_algorithm
{
    private:
        ...
        bool rearranging_intra_a_component;
        int comp_id;
        ...
        int num_local_procs;
        long *send_displs_in_remote_procs;
        long *recv_displs_in_current_proc;
        long *transfer_size_with_remote_procs;
        ...
        void unpack_segment_data(char *, char *, int, int, int, int, int, long);
        MPI_Request * request;
        bool is_first_run;
		bool current_send_have_been_waited;
    ...
    public:
		...
		void set_rearranging_intra_a_component() { rearranging_intra_a_component = true; }
        long get_history_receive_sender_time();
		void wait_sending_data();
};
