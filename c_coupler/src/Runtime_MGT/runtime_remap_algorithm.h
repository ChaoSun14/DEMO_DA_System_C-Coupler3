...
class Runtime_remap_algorithm
{
    ...
    public:    
        Runtime_remap_algorithm(Runtime_remapping_weights_container*, Field_mem_info *, Field_mem_info *, int);
        Runtime_remapping_weights_container *get_runtime_remapping_weights_container() { return runtime_remapping_weights_container; }
        bool run(bool);
