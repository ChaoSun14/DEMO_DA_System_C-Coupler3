...
class Decomp_grid_info
{
    ...
    public:
        ...
        Decomp_grid_info(int, Remap_grid_class*, Remap_grid_class*);
		Decomp_grid_info(int, Remap_grid_class*, Remap_grid_data_class *, Remap_grid_data_class *, Remap_grid_data_class *, Remap_grid_data_class *, Remap_grid_data_class *, Remap_grid_data_class *);
        ~Decomp_grid_info();
...
class Decomp_grid_mgt
{
    ...
    public:
		...
		Decomp_grid_info *add_decomp_grid_info(int, Remap_grid_class *, Remap_grid_class *);
        ~Decomp_grid_mgt();
		...
		void delete_decomp_grid(Decomp_grid_info *);
		void add_decomp_grid_info(Decomp_grid_info *);
};
