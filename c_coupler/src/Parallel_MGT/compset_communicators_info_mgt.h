...
class Comp_comm_group_mgt_node
{
    private:
        ...
        MPI_Comm comm_group;
		MPI_Comm PIO_sub_comm;
		int num_PIO_procs;
		int PIO_proc_ID_stride;
		int PIO_proc_mark;
    ...
    public:
		...
		void generate_PIO_comm_info();
        MPI_Comm get_comm_group() const { return comm_group; }
		MPI_Comm get_PIO_sub_comm() const { return PIO_sub_comm; }
		int get_num_PIO_procs() const { return num_PIO_procs; }
		int get_PIO_proc_ID_stride() const { return PIO_proc_ID_stride; }
		int get_PIO_proc_mark() const { return PIO_proc_mark; }
		...
		void set_num_members_in_ensemble(int number) { num_members_in_ensemble = number; }
};
...
class Comp_comm_group_mgt_mgr
{
    private:
        ...
        char *log_buffer;
        int log_buffer_content_size;
		int max_num_of_PIO_procs;

    public:
        Comp_comm_group_mgt_mgr(const char*);
        ~Comp_comm_group_mgt_mgr();
        int register_component(const char*, const char*, MPI_Comm&, int, bool, int, int, const char*);
		...
		void set_max_num_of_PIO_procs(int proc_num) { this->max_num_of_PIO_procs = proc_num; }
		int get_max_num_of_PIO_procs() { return max_num_of_PIO_procs; }
