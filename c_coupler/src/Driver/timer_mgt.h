...
#define TIME_FORMAT_YYYY                 ((long)(0x000000F000000))
#define TIME_FORMAT_YYYYMM               ((long)(0x000000FF00000))
#define TIME_FORMAT_YYYYMMDD             ((long)(0x000000FFF0000))
#define TIME_FORMAT_YYYYMMDDHHMMSS       ((long)(0x000000FFFFFF0))
#define TIME_FORMAT_YYYYMMDDSSSSS        ((long)(0x000000FFF000F))
#define TIME_FORMAT_MMO                  ((long)(0x0000000F00000))
#define TIME_FORMAT_MMDDSSSSS            ((long)(0x0000000FF000F))
#define TIME_FORMAT_MMDDHHMMSS           ((long)(0x0000000FFFFF0))
#define TIME_FORMAT_DD                   ((long)(0x00000000F0000))
#define TIME_FORMAT_DDSSSSS              ((long)(0x00000000F000F))
#define TIME_FORMAT_DDHHMMSS             ((long)(0x00000000FFFF0))
#define TIME_FORMAT_SSSSS                ((long)(0x000000000000F))
#define TIME_FORMAT_HHMMSS               ((long)(0x000000000FFF0))
#define TIME_FORMAT_YYYYMMDDHHMM         ((long)(0x000000FFFFF00))
#define TIME_FORMAT_MMDD                 ((long)(0x0000000FF0000))
#define TIME_FORMAT_MMDDHHMM             ((long)(0x0000000FFFF00))
#define TIME_FORMAT_DDHHMM               ((long)(0x00000000FFF00))
#define TIME_FORMAT_HHMM                 ((long)(0x000000000FF00))
#define TIME_FORMAT_YYYYMMDDHH           ((long)(0x000000FFFF000))
#define TIME_FORMAT_MMDDHH               ((long)(0x0000000FFF000))
#define TIME_FORMAT_DDHH                 ((long)(0x00000000FF000))
#define TIME_FORMAT_HH                   ((long)(0x000000000F000))
#define TIME_FORMAT_SECONDS              ((long)(0x00000F0000000))
#define TIME_FORMAT_NMINUTES             ((long)(0x0000F00000000))
#define TIME_FORMAT_NHOURS               ((long)(0x000F000000000))
#define TIME_FORMAT_NDAYS                ((long)(0x00F0000000000))
#define TIME_FORMAT_NMONTHS              ((long)(0x0F00000000000))
#define TIME_FORMAT_NYEARS               ((long)(0xF000000000000))
...
public:
    Periodical_timer(int, int, const char*, int, int, int, const char*);
    Periodical_timer(int, int, Periodical_timer*);
    Periodical_timer(const char*, long &, int, bool, bool &);
    ~Periodical_timer();
    bool is_timer_on();
    ...
    bool is_the_same_with(Periodical_timer *);
};


class Time_slots_points
{
private:
    bool is_slot_nor_point; // true means slot, false means point
    std::vector<std::pair<int*, int*> > slots_or_points;
    const char *time_format;
    bool time_segment_masks[12];
    long time_format_ID;

public:
    Time_slots_points(std::vector<std::pair<long, long> >&, bool, const char *, const char *, const char *);
    ~Time_slots_points();
    long get_time_format_ID(const char *);
    long get_time_format_ID() { return time_format_ID; }
    const char *get_time_format() { return time_format; }
    bool check_calendar_time_segment_values(const bool *, const int *);
    bool get_time_segment_values(long, long, bool*, int*, bool);
    bool is_slot_point_on(int, long, long, int);
    bool is_on(int, long, long);
    bool get_is_slot_nor_point() { return is_slot_nor_point; }
    void get_time_segment_values_from_full_time(long, int*);
    int compare_time_format_and_frequency_unit(long, const char *);
};
...
private:
    ...
    std::vector<Coupling_timer *> children_coupling_timers;
    long time_window_start_full_time;

public:
    Coupling_timer(int, int, const char*, int, int, int, const char*);
    Coupling_timer(int, int, Coupling_timer*);
    Coupling_timer(int, int, Time_slots_points *, Periodical_timer *, const char *);
    Coupling_timer(const char*, long &, int, bool, bool &);
    ~Coupling_timer();
    bool is_timer_on(long = -1);
    bool is_timer_on(int, int, int, int, int, int, int, int, int, int);
    int get_timer_id() { return timer_id; }
    int get_comp_id() { return comp_id; }
    bool is_empty_timer();
    int get_frequency_count();
    int get_local_lag_count();
    int get_remote_lag_count();
    const char *get_frequency_unit();
    void write_timer_into_array(char **, long &, long &);
    void get_time_of_next_timer_on(Time_mgt *, int, int, int, int, int, int, int &, int &, int &, bool);
    void reset_remote_lag_count();
    bool is_the_same_with(Coupling_timer *);
    void add_child_coupling_timer(Coupling_timer *, const char *);
    int get_num_children() { return children_coupling_timers.size(); }
};
...
public:
    ...
    int define_timer(int, Time_slots_points *, Periodical_timer *, const char *);
...
private:
    ...
    int stop_n;
    Coupling_timer *coupling_timer1;

public:
    Time_mgt() { coupling_timer1 = NULL; }
    ...
    void check_timer_format_XML(const char*, int, int, int, bool, const char*, const char*, int);
    ...
    int get_comp_id() { return comp_id; }
    Coupling_timer *get_restart_timer() { return restart_timer; }
    Time_mgt *clone_time_mgr(Time_mgt *, int);
