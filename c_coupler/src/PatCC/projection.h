...
extern void lonlat2xyz(double, double, PAT_REAL *, PAT_REAL *, PAT_REAL *);
extern void calculate_unit_vectors(double, double, PAT_REAL *, PAT_REAL *, PAT_REAL *, PAT_REAL *, PAT_REAL *, PAT_REAL *);
