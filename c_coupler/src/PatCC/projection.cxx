 ...
 *      Z = 2 * z / (1 + y)
 */
void lonlat2xyz(double lon, double lat, PAT_REAL *x, PAT_REAL *y, PAT_REAL *z)
{
...
using std::fabs;
using std::min;
void calculate_unit_vectors(double t_lon, double t_lat, PAT_REAL *v1_x, PAT_REAL *v1_y, PAT_REAL *v1_z, PAT_REAL *v2_x, PAT_REAL *v2_y, PAT_REAL *v2_z)
{
    PAT_REAL t_x, t_y, t_z;
    ...
    if (min_dir == fabs(t_x)) {
        ...
        EXECUTION_REPORT(REPORT_ERROR, -1, false, "Software error in calculate_unit_vectors");
    }
