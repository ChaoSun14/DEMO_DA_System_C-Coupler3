...
class Remap_grid_class
{
    ...
    public:
		...
		Remap_grid_class(const char*, const char *, Remap_grid_data_class *, Remap_grid_data_class *, Remap_grid_data_class *, Remap_grid_data_class *, Remap_grid_data_class *, Remap_grid_data_class *, int);
        ~Remap_grid_class();
		...
		void set_vertex_values_generated_in_default() { are_vertex_values_set_in_default = true; }
        ...
        void check_center_vertex_values_consistency_2D(bool);
		...
		const char *get_sphere_grid_coord_unit();
		bool has_V3D_sub_grid();
		Remap_grid_class *get_V3D_sub_grid();
        Remap_grid_class(Remap_grid_class*, const char *, const char *, long &, bool);
		...
		void set_generated_from_duplication() { generated_from_duplication = true; }
		void set_local_cell_global_indexes(const int *, bool);
		const int *get_local_cell_global_indexes() { return local_cell_global_indexes; }
		int get_num_active_cells();
		bool is_point_in_subdomain(double, double, double, double, double, double);
		bool are_all_active_cells_in_subdomain(double, double, double, double);
		void empty_grid_data();
        void transform_coord_unit_from_radian_to_degrees();
		void remove_vertexes_info();
};
