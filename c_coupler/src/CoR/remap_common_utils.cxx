...
//            max_lon = point_coord1_value;
//            for (int i = 0; i < num_vertexes; i ++) {
//                max_lon = max_lon < cell_vertex_coord1_values[i] ? cell_vertex_coord1_values[i] : max_lon;
//            }

//            point_coord1_value = max_lon - point_coord1_value > 180. ? point_coord1_value + 360.0 : point_coord1_value;
//            EXECUTION_REPORT_LOG(REPORT_LOG, -1, true, "%lf  %lf", point_coord1_value, point_coord2_value);
//            for (int i = 0; i < num_vertexes; i ++) {
//                cell_vertex_coord1_values[i] = max_lon - cell_vertex_coord1_values[i] > 180. ? cell_vertex_coord1_values[i] + 360.0 : cell_vertex_coord1_values[i];
//                EXECUTION_REPORT_LOG(REPORT_LOG, -1, true, "%lf  %lf", cell_vertex_coord1_values[i], cell_vertex_coord2_values[i]);
//            }
//        }
