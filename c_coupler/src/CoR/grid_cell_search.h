...
class H2D_grid_cell_search_cell
{
    ...
    public:
        H2D_grid_cell_search_cell(int, double, double, bool, int, const double*, const double*, int, bool);
...
class H2D_grid_cell_search_tile
{
    ...
    public:
        ...
        H2D_grid_cell_search_tile(int, H2D_grid_cell_search_cell**, H2D_grid_cell_search_cell**, long*, H2D_grid_cell_search_tile*, double, double, double, double, bool);
...
class H2D_grid_cell_search_engine
{
    private:
		...
		double grid_min_lat;
		double grid_max_lat;
		double grid_lon_range;
		double grid_lat_range;
		
    public:
        H2D_grid_cell_search_engine(Remap_grid_class*, const double*, const double*, const bool*, int, const double*, const double*, int, bool);
        ...
        void search_nearest_points_var_number(int, long, double, double, int&, long*, double *, bool);
        bool search_nearest_points_var_distance(double, long, double, double, int&, long*, double*, bool);
		...
		void set_dist_threshold(double dist_threshold) { this->dist_threshold = dist_threshold;}
        const H2D_grid_cell_search_cell* get_cell(int) const;
        void update(const bool*);
		void sort_nearest_points(int);
};
