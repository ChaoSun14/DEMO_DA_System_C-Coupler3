...
class Remap_weight_of_operator_instance_class
{
    ...
    public: 
		...
		Remap_operator_basis *get_duplicated_remap_operator() { return duplicated_remap_operator; }
        Remap_grid_class *get_operator_grid_src();
        Remap_grid_class *get_operator_grid_dst();
        Remap_weight_of_operator_instance_class *generate_parallel_remap_weights(Remap_grid_class**);
...
class Remap_weight_of_strategy_class
{
    ...
    public:
        ...
        Remap_weight_of_strategy_class(const char *, Remap_strategy_class *, Remap_grid_class *, Remap_grid_class *, const char *, bool, int, int, int, int);
