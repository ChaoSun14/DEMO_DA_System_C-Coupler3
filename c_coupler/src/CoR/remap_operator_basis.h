...
class Remap_operator_basis
{
    ...
    public:
		...
		virtual void initialize() {     this->displ_src_cells_overlap_with_dst_cells = NULL; this->index_src_cells_overlap_with_dst_cells = NULL;   }
		...
		bool get_extrapolate_enabled() { return enable_extrapolate; }
};
