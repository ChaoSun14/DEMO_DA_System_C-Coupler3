module variable_mod_1
    use spmd_init_mod_1, only: masterpe, ier, mpi_comm, npes, mytask_id
    use decomp_init_mod_1, only : local_grid_index, local_grid_size
    use grid_init_mod_1, only: nlat, nlon, nlev
    use parse_namelist_mod_1, only: NANALS
...
contains
    ...
    subroutine read_input_variables_da
        ...
        integer :: rTAUXid, rTAUYid, rPSid, rV10id, rmaskid, rTid
        integer :: i, j, k
